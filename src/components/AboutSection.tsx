                ...
                <Card className="h-full border-primary/10 bg-card/50 backdrop-blur-sm">
                  <CardContent className="pt-6">
                    ...
                    <div className="space-y-2">
                      <p className="font-medium">BSc in Software engineer</p>
          ...
          >
            ...
            >
              <Avatar className="w-40 h-40 border-4 border-primary/20">
                <AvatarImage
                  src="/imgs/engr_kaleem.JPG"
                  alt="Engr Kaleem"
                  loading="lazy"
                />
                <AvatarFallback>Kaleem</AvatarFallback>
              </Avatar>
            ...
            >
              <h3 className="text-2xl font-bold">Engr Kaleem</h3>
              <p className="text-muted-foreground">
            ...
            >
              <Button className="gap-2" asChild onClick={handledownload}>
                <a href={resumeUrl} download="Kaleem_Full_Stack_CV.pdf">
