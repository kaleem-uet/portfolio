  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Engr Kaleem - Full-Stack Developer & Software Engineer"
        />
        <meta
          name="keywords"
          content="Full-Stack Developer, Software Engineer, React, Node.js, JavaScript, Gen AI"
        />
              ...
              >
                ...
                <div className="space-y-2 font-mono text-sm">
                  ...
                  >
                    ...
                    <span className="text-gray-500">:</span>{" "}
                    <span className="text-green-600">'Engr Kaleem'</span>
                    <span className="text-gray-500">,</span>
                  </motion.div>
                  ...
                  >
                    ...
                    <span className="text-gray-500">,</span>{" "}
                    <span className="text-green-600">'Gen AI'</span>
                    <span className="text-orange-500">]</span>
                    <span className="text-gray-500">,</span>
                  </motion.div>
